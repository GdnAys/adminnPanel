...
class ButtonSayfaYonetimi extends Component {
      ...
      <div className="animated fadeIn">
        <Row>
          <Col xs="12">
            ...
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"></i><strong>Single button sayfayonetimi</strong>
              </CardHeader>
              <CardBody>
            ...
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"></i><strong>Split button sayfayonetimi</strong>
              </CardHeader>
              <CardBody>
...
export default ButtonSayfaYonetimi;*/
