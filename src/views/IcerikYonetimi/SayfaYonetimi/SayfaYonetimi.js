...
class SayfaYonetimi extends Component {
  constructor(props) {
    super(props);
      ...
      <div className="animated fadeIn">
        <Row>
          <Col xs="12">
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"></i><strong>SayfaYonetimi</strong>
                <div className="card-header-actions">
                  <a href="https://reactstrap.github.io/components/sayfayonetimi/" rel="noreferrer noopener" target="_blank" className="card-header-action">
            ...
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"></i><strong>Custom SayfaYonetimi</strong>
              </CardHeader>
              <CardBody>
